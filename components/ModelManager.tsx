...
import { testCustomModelConnection } from '../services/aiService';
                    ...
                    {activeTab === 'custom' && (
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="model" value={customConfig.model} onChange={handleCustomConfigChange} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-400" placeholder="gpt-4o" />
                            </div>
                            <div className="flex items-center justify-between">
                               <button onClick={handleTest} disabled={testStatus === 'testing'} className="px-4 py-2 text-sm font-semibold text-indigo-600 border border-indigo-300 rounded-lg hover:bg-indigo-50 transition-colors disabled:opacity-50">
                                    {testStatus === 'testing' ? <Loader /> : t('modelManager.testButton')}
                                </button>
